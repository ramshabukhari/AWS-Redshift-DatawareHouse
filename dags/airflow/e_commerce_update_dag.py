...
with DAG('e_commerce_update_dag', default_args=default_args, schedule_interval='@daily',catchup=False) as dag:
    ...
    clean_order_reviews_dataset_4 = PythonOperator(
            ...
            op_kwargs={'filename' :'/usr/local/airflow/dags/airflow/data_files_split/order_reviews_part_4.csv'}
    )
    
    upload_S3_customers_4 = PythonOperator(
                    task_id='upload_S3_customers_4',
                    python_callable=upload_file_to_S3_with_hook,
                    op_kwargs={'filename' : '/usr/local/airflow/dags/airflow/data_files_split/customers_part_4.csv',
    ...
    upload_S3_geolocation_4 = PythonOperator(
                    ...
                    python_callable=upload_file_to_S3_with_hook,
                    op_kwargs={'filename' : '/usr/local/airflow/dags/airflow/data_files_split/geolocation_part_4.csv',
    ...
    upload_S3_order_items_4 = PythonOperator(
                    ...
                    python_callable=upload_file_to_S3_with_hook,
                    op_kwargs={'filename' : '/usr/local/airflow/dags/airflow/data_files_split/order_items_part_4.csv',
    ...
    upload_S3_order_payments_4 = PythonOperator(
                    ...
                    python_callable=upload_file_to_S3_with_hook,
                    op_kwargs={'filename' : '/usr/local/airflow/dags/airflow/data_files_split/order_payments_part_4.csv',
    ...
    upload_S3_orders_4 = PythonOperator(
                    ...
                    python_callable=upload_file_to_S3_with_hook,
                    op_kwargs={'filename' : '/usr/local/airflow/dags/airflow/data_files_split/orders_part_4.csv',
    ...
    upload_S3_products_4 = PythonOperator(
                    ...
                    python_callable=upload_file_to_S3_with_hook,
                    op_kwargs={'filename' : '/usr/local/airflow/dags/airflow/data_files_split/products_part_4.csv',
    ...
    upload_S3_sellers_4 = PythonOperator(
                    ...
                    python_callable=upload_file_to_S3_with_hook,
                    op_kwargs={'filename' : '/usr/local/airflow/dags/airflow/data_files_split/sellers_part_4.csv',
    ...
    upload_S3_product_category_name_translation_3 = PythonOperator(
                    ...
                    python_callable=upload_file_to_S3_with_hook,
                    op_kwargs={'filename' : '/usr/local/airflow/dags/airflow/data_files_split/product_category_name_translation_part_3.csv',
