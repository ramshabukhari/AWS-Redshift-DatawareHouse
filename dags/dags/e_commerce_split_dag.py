...
with DAG('e_commerce_dag_split', default_args=default_args, schedule_interval='@daily',catchup=False) as dag:
    ...
    #                             'bucket_name': 'brazillian-e-commerce-data'}
    #         )
    upload_S3_customers_1 = DummyOperator(
           task_id='upload_S3_customers_1'
    )

    upload_S3_customers_2 = DummyOperator(
           task_id='upload_S3_customers_2'
    )


    upload_S3_customers_3 = DummyOperator(
           task_id='upload_S3_customers_3'
    )


    upload_S3_geolocation_1 = DummyOperator(
           task_id='upload_S3_geolocation_1'
    )

    upload_S3_geolocation_2 = DummyOperator(
           task_id='upload_S3_geolocation_2'
    )

    upload_S3_geolocation_3 = DummyOperator(
           task_id='upload_S3_geolocation_3'
    )


    upload_S3_order_items_1 = DummyOperator(
           task_id='upload_S3_order_items_1'
    )

    upload_S3_order_items_2 = DummyOperator(
           task_id='upload_S3_order_items_2'
    )

    upload_S3_order_items_3 = DummyOperator(
           task_id='upload_S3_order_items_3'
    )


    upload_S3_order_payments_1 = DummyOperator(
           task_id='upload_S3_order_payments_1'
    )

    upload_S3_order_payments_2 = DummyOperator(
           task_id='upload_S3_order_payments_2'
    )

    upload_S3_order_payments_3 = DummyOperator(
           task_id='upload_S3_order_payments_3'
    )


    upload_S3_order_reviews_1 = DummyOperator(
           task_id='upload_S3_order_reviews_1'
    )

    upload_S3_order_reviews_2 = DummyOperator(
           task_id='upload_S3_order_reviews_2'
    )

    upload_S3_order_reviews_3 = DummyOperator(
           task_id='upload_S3_order_reviews_3'
    )


    upload_S3_orders_1 = DummyOperator(
           task_id='upload_S3_orders_1'
    )

    upload_S3_orders_2 = DummyOperator(
           task_id='upload_S3_orders_2'
    )

    upload_S3_orders_3 = DummyOperator(
           task_id='upload_S3_orders_3'
    )


    upload_S3_products_1 = DummyOperator(
           task_id='upload_S3_products_1'
    )

    upload_S3_products_2 = DummyOperator(
           task_id='upload_S3_products_2'
    )

    upload_S3_products_3 = DummyOperator(
           task_id='upload_S3_products_3'
    )


    upload_S3_sellers_1 = DummyOperator(
           task_id='upload_S3_sellers_1'
    )

    upload_S3_sellers_2 = DummyOperator(
           task_id='upload_S3_sellers_2'
    )

    upload_S3_sellers_3 = DummyOperator(
           task_id='upload_S3_sellers_3'
    )


    upload_S3_product_category_name_translation_1 = DummyOperator(
           task_id='upload_S3_product_category_name_translation_1'
    )

    upload_S3_product_category_name_translation_2 = DummyOperator(
           task_id='upload_S3_product_category_name_translation_2'
    )
